...
public:
	...
	virtual void Echo(UpLoadEchoRequest *request, UpLoadEchoResponse *response,
...
using EchoDone = std::function<void (UpLoadEchoResponse *, srpc::RPCContext *)>;

class SRPCClient : public srpc::SRPCClient
{
public:
	void Echo(const UpLoadEchoRequest *req, EchoDone done);
	void Echo(const UpLoadEchoRequest *req, UpLoadEchoResponse *resp, srpc::RPCSyncContext *sync_ctx);
	WFFuture<std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>> async_Echo(const UpLoadEchoRequest *req);
...
inline Service::Service(): srpc::RPCService("UpLoad")
{
...
inline void SRPCClient::Echo(const UpLoadEchoRequest *req, EchoDone done)
{
...
inline void SRPCClient::Echo(const UpLoadEchoRequest *req, UpLoadEchoResponse *resp, srpc::RPCSyncContext *sync_ctx)
{
...
inline WFFuture<std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>> SRPCClient::async_Echo(const UpLoadEchoRequest *req)
{
	using RESULT = std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
	auto *task = this->create_rpc_client_task<UpLoadEchoResponse>("Echo", srpc::RPCAsyncFutureCallback<UpLoadEchoResponse>);
...
inline void SRPCHttpClient::Echo(const UpLoadEchoRequest *req, EchoDone done)
{
	auto *task = this->create_rpc_client_task("Echo", std::move(done));
...
inline void SRPCHttpClient::Echo(const UpLoadEchoRequest *req, UpLoadEchoResponse *resp, srpc::RPCSyncContext *sync_ctx)
{
	auto res = this->async_Echo(req).get();
...
inline WFFuture<std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>> SRPCHttpClient::async_Echo(const UpLoadEchoRequest *req)
{
	using RESULT = std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
...
inline void BRPCClient::Echo(const UpLoadEchoRequest *req, EchoDone done)
{
	auto *task = this->create_rpc_client_task("Echo", std::move(done));
...
inline void BRPCClient::Echo(const UpLoadEchoRequest *req, UpLoadEchoResponse *resp, srpc::RPCSyncContext *sync_ctx)
{
	auto res = this->async_Echo(req).get();
...
inline WFFuture<std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>> BRPCClient::async_Echo(const UpLoadEchoRequest *req)
{
	using RESULT = std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
...
inline void TRPCClient::Echo(const UpLoadEchoRequest *req, EchoDone done)
{
	auto *task = this->create_rpc_client_task("/UpLoad/Echo", std::move(done));
...
inline void TRPCClient::Echo(const UpLoadEchoRequest *req, UpLoadEchoResponse *resp, srpc::RPCSyncContext *sync_ctx)
{
	auto res = this->async_Echo(req).get();
...
inline WFFuture<std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>> TRPCClient::async_Echo(const UpLoadEchoRequest *req)
{
	using RESULT = std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
	auto *task = this->create_rpc_client_task<UpLoadEchoResponse>("/UpLoad/Echo", srpc::RPCAsyncFutureCallback<UpLoadEchoResponse>);
...
inline void TRPCHttpClient::Echo(const UpLoadEchoRequest *req, EchoDone done)
{
	auto *task = this->create_rpc_client_task("Echo", std::move(done));
...
inline void TRPCHttpClient::Echo(const UpLoadEchoRequest *req, UpLoadEchoResponse *resp, srpc::RPCSyncContext *sync_ctx)
{
	auto res = this->async_Echo(req).get();
...
inline WFFuture<std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>> TRPCHttpClient::async_Echo(const UpLoadEchoRequest *req)
{
	using RESULT = std::pair<UpLoadEchoResponse, srpc::RPCSyncContext>;
	auto *pr = new WFPromise<RESULT>();
	auto fr = pr->get_future();
